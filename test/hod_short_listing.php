...
if ($row['hod_remark']=='Shortlist'||$row['hod_remark']=='Hold'||$row['hod_remark']=='Reject'){
    $id=$row['unique_id'];
    echo "<tr>";
    echo "<td>" . $row['name'] ."'</td>";
...
//  echo "<td><a href='viewrequision.php?variable1=".$id."'>View Requisition</a>" ."</td>";
    ...
    echo "<td>" . $row['remark'] ."</td>";
    echo   '  <td><a target="__blank" href="'. $row['resume'] .'" style="text-decoration:none;">Open</a></td>';
    echo "<td><select name='hod_remark' id='' disabled>
    <option selected>".$row['hod_remark']."</option>
    <option value='Shortlist'>Shortlist</option>
    <option value='Hold'>Hold</option>
    <option value='Reject'>Reject</option></select></td>
...
<?php
 echo '<td><button  name="submit" class="btn btn-block btn-primary" disabled>Submit</button></td>';
//  echo "<td><a href='viewrequision.php?variable1=".$id."'>View Requisition</a>" ."</td>";
...
?>     
        ...
        <a href="submitforinterview.php?req=<?php echo $id ?>"> <button name="Submit For Interview" >Submit to HoD to Shortlist</button></a>
