...
{
  echo '<a href="calenderfilldata.php"><button class="btn btn-primary">Fill Data</button></a>';
}
?>
</center>
<br>
...
foreach($counter as $row) {
        ...
        echo " <tr>";
        echo "<th>".$i."</th>";
        echo "<td>" . implode(",",(array)$row['dept']) ."</td>";
 ...
 echo  '    
  ...
  <td id="Septp'.$i.'"></td><td id="septc'.$i.'"></td><td id="Octp'.$i.'"></td><td id="Octc'.$i.'"></td><td id="Novp'.$i.'"></td><td id="Novc'.$i.'"></td><td id="Decp'.$i.'"></td><td id="Decc'.$i.'"></td><td>'.count($row['empIds']).'</td>
';
?>
<script>
