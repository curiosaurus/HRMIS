...
<div  style="margin-bottom: 100px; border: 1px solid lightblue; padding: 50px;">
    ...
    <br>    <div class="container" style="border: 1px solid lightblue; padding: 2px;">
...
function pp(){
    ...
    window.location.href="empviewskillmatrix.php?year="+y;
}
</script>
    <br><br>
    <?php
    
$skillscollection = $companydb->$y;
$empcollection = $companydb->empcollection;
//echo "123";
if(isset ($_SESSION['Emp Code']))
{
    $empcode = $_SESSION['Emp Code'];
    //echo "123";
