...
<div class="container" style="margin-right: 0%;margin-left:10%;width: 76%;">
    ...
    <div class="container" style="padding: 1.2rem; text-transform: uppercase;">
            <table class="table table-bordered">
             ...
             <tr>
                   ...
                   <tr> 
                       ...
                       <td>MOOM</td>
                       <td>36</td>
                       <td><a href="hr_admin_skill_5.html"><button name="" class="btn btn-block btn-success">UPDATE</button></a>
                       </td>
                   </tr>
                   <tr> 
                        <td>RM00107</td>
           ...
           <div>
<!-- <center> <a href="hr_admin_dashboard.html"></a> <button style=" margin:2em; padding:0em 2em;" class="btn btn-primary btn-lg">Submit</button> </center>  -->
</body>
</html>
