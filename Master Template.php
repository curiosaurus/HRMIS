...
<div class="container">
    ...
    <br>
        ...
        <div class="row justify-content-md-start">
            ...
            <div class="col-md-2">
                <button class="btn btn-outline-primary btn-sm btn-block">HOD</button>
            </div>
            <div class="col-md-2">
                <button class="btn btn-outline-primary btn-sm btn-block">Super HOD</button>
            </div>
            <div class="col-md-2">
                <button class="btn btn-outline-primary btn-sm btn-block">EMPLOYEE</button>
            </div>
            
            <div class="col-md-2">
                <button class="btn btn-outline-primary btn-sm btn-block">MD</button>
            </div>
