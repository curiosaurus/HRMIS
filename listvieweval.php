...
function pp(){
    ...
    window.location.href="listvieweval.php?year="+y+"&skill="+s;
}
</script>
        </div>
    </div>
...
<?php
    ...
    $counter = $training_lecture->find(['year'=>$y,'skill'=>$s, 'evaluation'=>array('$exists'=>true)]);
?>
...
<?php
    ...
    echo "<td><a href='employeeevallist.php?uniqueid=$pas&year=$y'>View Evaluation </a>" ."</td>";
