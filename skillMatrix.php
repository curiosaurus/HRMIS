...
// $managerialSkill = array();
// foreach($counter2 as $row){
//     array_push($managerialSkill,$row['skillname']);
// }          


// $counter2 = $empcoll->find(array('department' => $var, 'skilltype' => 'functional'));
// $preferrableSkill = array();
// foreach($counter2 as $row){
//     array_push($preferrableSkill,$row['skillname']);
// }
...
// foreach($counter2 as $row){
//     array_push($systemRequirements,$row['skillname']);
// }  
    ...
    <table class="table"  border="1">
        ...
        <?php 
            ...
            foreach($counter2 as $row){
                ...
                <td><input type="" disabled name="managerialSkill['.$counter3.'][2]"  id=""  style="width: 50px;"></td>
                </tr>';
        ...
        <tr> 
            ...
            foreach($counter2 as $row){
                ...
                <td><input type="number" disabled name="preferredSkill['.$counter.'][2]" id=""  style="width: 50px;"></td>
                </tr>';
        ...
        <tr>
            ...
            <?php 
                ...
                <td><input  type="number" disabled name="systemRequirements['.$counter4.'][2]" id=""  style="width: 50px;"></td>
                </tr>';
