...
<br><br>
    ...
    <div class="row justify-content-md-start" style="height: 300px; margin-left: 30px; ">
        ...
        <div class="col-md-5" style=" border: 1px solid lightblue; height: 200px; ">
            <div class="row justify-content-md-center" style="font-size: 20px; color: white; background-color:rgba(25, 0, 255, 0.705); height: 50px;">WELFARE NOTICE</div>
        </div>
