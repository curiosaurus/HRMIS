...
<form action="uploadAttendance.php?year=<?php echo $y;?>" method="post" enctype="multipart/form-data">
 ...
 <table class="table table-bordered">
        ...
        <?php
            ...
            $counter = 0;
            $result = $trainingCollection->find(array('year'=>$y, 'attended_emp'=>array('$exists'=>false)));
